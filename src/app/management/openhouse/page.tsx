...
export default function OpenHouseAdminPage() {
  const [registrations, setRegistrations] = useState<OpenHouseLead[]>([]);
  const [stats, setStats] = useState<OpenHouseStats>({
    total: 0,
    confirmed: 0,
    attended: 0,
    kindergarten: 0,
  ...
  const [setting, setSetting] = useState<OpenHouseSetting>({
    id: 'default',
    is_active: true,
    inactive_message: '',
